import { headersToObject } from '../core/utils.js';

/** Native HTTP via Tauri (avoids WebView fetch failures on cloud APIs). */
export async function nativeHttpRequest(url, init = {}) {
...
/** Native SSE streaming — WebView fetch often fails with "Load failed". */
export async function nativeHttpStream(url, init = {}) {
